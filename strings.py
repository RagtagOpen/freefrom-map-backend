...
require_type = 'type is required to create a new link. type must be one of ("resource_link", "honorable_mention", or "innovative_policy_idea")'
invalid_link_type = 'type must be one of ("resource_link", "honorable_mention", or "innovative_policy_idea")'
